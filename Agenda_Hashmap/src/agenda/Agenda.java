...
public class Agenda {
	...
	public static void main(String args[]) {
		...
		a.insertarArray(contactes, a);
		a.otraManeraDeMostrar();
	}
	...
	// AL INSERTAR EL ARRAY CONTACTOS, LOS VALORES SE PIERDEN YA QUE EL ARRAY SOLO TIENE LA KEY
	public void insertarArray(String [] ct, Agenda a) {
	...
	// MOSTRANDO LA AGENDA CON UN FOREACH
	public void otraManeraDeMostrar() {
		persones.forEach((k, v) -> System.out.println("Key: " + k + ": Value: " + v));
	}
	/*public void insereix(String a, String b) {
		a.persones.put(a,b);
	}*/
