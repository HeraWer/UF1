...
public class Agenda2 {
	...
	public static void main(String args[]) {
		...
		// Cridem un mètode que mostrarà la llista de contactes de l’agenda. L’orde
		// establert als element inserits al TreeMap és ascendent independentment del
		// seu ordre d’inserció.
