...
private HashMap cursos;
 /*Un HashMap es una col.lecio on cada
node es del
 * tipus (Objecte clau, Objecte Dades)
funcionant
 * l'objecte clau com un identificador.
En aquest
 * cas la clau es un String amb el codi
del curs,
 * mentre de que l'objecte dades es un
del tipus
 * Curs.
 */
public Pt2(){
...
System.out.println("HIHAN "+x.cursos.size()+" CURSOS");
 ...
 break;
 case 2: System.out.println("Introdueix el codidel curs");
...
break;
 case 3: System.out.println("Introdueix el codi del curs");
id=dades.next().toUpperCase();
if(x.cursos.containsKey(id)){
...
break;
 case 4: System.out.println("Introdueix el codi del curs");
id=dades.next().toUpperCase();
if(x.cursos.containsKey(id)){
 x.cursos.remove(id);
